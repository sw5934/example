					...
					<div class="col-md-12">
						<div class="card card-default">
							<div class="card-header">
								<!-- 상단 글등록 버튼 -->
								<button id="newBtn" class="btn btn-primary" onclick="OpenWindow('regist','',600,400);">글등록</button>
									...
									<c:if test="${!empty noticeList }">
										<c:forEach items="${noticeList }" var="notice">
											<tr>
												...
												<td>
													<a href="#" data-name="title" onclick="OpenWindow('detail/${notice.nno }')">
														${notice.title }
													</a>
												</td>
												<td class="text-center">${notice.id }</td>
												<td class="text-center">
													<fmt:formatDate value="${notice.regDate }" pattern="yyyy-MM-dd" /></td>
							...
							<div class="card-footer">
								<div class="text=center">
									<ul class="pagination">
										<li class="page-item">
											<a class="page-link" href="listSearch${pageMaker.makeQuery(1) }">&lt;&lt;</a></li>
