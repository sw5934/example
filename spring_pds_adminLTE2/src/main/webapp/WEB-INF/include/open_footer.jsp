...
<!-- InputMask -->
<script src="<%=request.getContextPath() %>/resources/bootstrap/plugins/inputmask/jquery.inputmask.bundle.js"></script>
...
<%@ include file="/WEB-INF/include/open_footer_js.jsp" %>
</html>